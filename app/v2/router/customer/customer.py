...
def create_profile_service(customer: CustomerReq = Body(...),
...
def update_profile_router(customer: CustomerReq, customert_id: int,
                          service=Depends(get_user)) -> DataResponse:
...
def get_profile_service(customer_id: int,
                        service=Depends(get_user)) -> DataResponse:
